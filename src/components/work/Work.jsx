        ...
        <div id="work">
            <div className="work-wrapper">
                ...
                <div className="work-list">
                    ...
                    <a href="https://tender-benz-7f5f5b.netlify.app/" target="_blank" rel="noreferrer" ><img className="app-img" src="/social-app.png" alt="" /></a>
                    </div>
                    <div className="work-item">
                    <a href="https://suspicious-einstein-fad332.netlify.app/" target="_blank" rel="noreferrer" ><img className="app-img" src="./twitter-app.png" alt="" /></a>
                    </div>
                </div>
